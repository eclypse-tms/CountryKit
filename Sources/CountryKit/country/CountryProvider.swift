        ...
        for (index, eachParsedLocaleList) in parsedLocaleList.enumerated() {
            ...
            if components.count == 19 {
                ...
                let wiki = Wiki(
                    ...
                    timeZoneOffsets: components[10].components(separatedBy: "|").compactMap { TimeZoneOffset(rawValue: $0) },
                    daylightSavingsTimeZoneOffsets: components[11].components(separatedBy: "|").compactMap { TimeZoneOffset(rawValue: $0) },
